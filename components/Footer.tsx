...
function FooterSection({ title, children }: { title: string, children: React.ReactNode }) {
  ...
  return (
    <div className="border-b border-[#AB9462]/30 lg:border-none last:border-0">
      <button
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#2C1D00] text-white rounded-t-[2.5rem] mt-8 lg:mt-0 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-3 pt-4 border-t border-[#AB9462]/30">
              {contactPhone && (
                <div className="flex flex-col gap-2">
                  <a href={`tel:${contactPhone}`} className="flex items-center gap-3 text-[#AB9462] hover:text-white transition-colors text-sm">
                    <i className="ri-phone-line"></i> {contactPhone}
                  </a>
                </div>
              )}
              {contactEmail && (
                <a href={`mailto:${contactEmail}`} className="flex items-center gap-3 text-[#AB9462] hover:text-white transition-colors text-sm">
        ...
        <div className="border-t border-[#AB9462]/30 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#FFCC00]/60">
          ...
          <p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#FFCC00] hover:text-white transition-colors font-medium"
            >
              Doctor Barns Tech
            </a>
          </p>
